...
(function($){
	$.prompt=function(message,options){
		...
		if(message.constructor==String)
		{
			message={
				state0:{
					html:message,buttons:options.buttons,focus:options.focus,submit:options.submit
				}
			};
		}
		var states="";
		...
		$.each(message,function(statename,stateobj){
			...
			$state.children('.'+options.prefix+'buttons').children('button').click(function(){
				...
				if(clicked==undefined){
					...
					clicked=clicked.value;var forminputs={};
			...
			var keyPressEventHandler=function(e){
				...
				var positionPrompt=function(){
					...
					$jqif.css({position:"absolute",height:$window.height(),width:"100%",top:0,left:0,right:0,bottom:0});
					$jqi.css({position:"absolute",top:options.top,left:"50%",marginLeft:(($jqi.outerWidth()/2)*-1)});};
					var stylePrompt=function(){$jqif.css({zIndex:options.zIndex,display:"none",opacity:options.opacity});
					...
					$jqif.fadeOut(options.overlayspeed,function(){
						...
						$jqib.remove();if(ie6&&!options.useiframe){
					...
					$.prompt.currentPrefix=$.prompt.defaults.prefix;$.prompt.setDefaults=function(o){
					...
					$.prompt.close=function(){
						$('#'+$.prompt.currentPrefix+'box').fadeOut('fast',function(){$(this).remove();});
					};
